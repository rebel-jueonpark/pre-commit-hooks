#!/usr/bin/env python3
"""Wrapper script for clang-tidy-diff."""
import re
import sys
...
class ClangTidyDiffCmd(StaticAnalyzerCmd):
    ...
    command = "git diff -U0 HEAD^ | python $REBEL_DEPENDENCY/llvm/share/clang/clang-tidy-diff.py -p1"
